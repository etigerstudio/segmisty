...
if __name__ == '__main__':
    ...
    elif unit == "numeric-segmenting":
        print(utils.try_numeric_segmenting("12") == 2)
        print(utils.try_numeric_segmenting("1.2") == 3)
        print(utils.try_numeric_segmenting(".2") is None)
        print(utils.try_numeric_segmenting("二○○一年") == 5)
        print(utils.try_numeric_segmenting("2003年") == 5)
        print(utils.try_numeric_segmenting("九月") == 2)
        print(utils.try_numeric_segmenting("9月") == 2)
        print(utils.try_numeric_segmenting("到2003年") is None)
        print(utils.try_numeric_segmenting("到9月") is None)
        print(utils.try_numeric_segmenting("12%") == 3)
        print(utils.try_numeric_segmenting("1.2％") == 4)
        print(utils.try_numeric_segmenting("百分之十六") == 5)
        print(utils.try_numeric_segmenting("百分之一百零三点六") == 9)
