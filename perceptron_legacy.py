# ========================================
# Structured Averaged Perceptron(legacy, slower, deprecated) 结构化平均感知机（已弃用，旧低速版）
# ========================================
...
class Perceptron:
    ...
    def train(self, sentences, tag_set, max_epoch=250, evaluate_filename=None, save_models=True):
        # last_f1 = float("-inf")
